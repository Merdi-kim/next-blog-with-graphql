  ...
  return (
    <div className='flex flex-col md:flex-row  bg-white shadow-lg rounded-lg p-4 mb-8'>
      <div className='w-full h-44 md:w-[40%] relative overflow-hidden shadow-md'>
        <img src={post.featuredImage.url} alt={post.title} className="object-top absolute h-full w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg" />
      </div>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-2 w-full'>
        <div className='flex items-center justify-center mt-2 md:mt-0 mb-0 w-full lg:w-auto mr-8'>
          <img src={post.author.photo.url} height="30px" width="30px" alt={post.author.name} className="align-middle rounded-[50%]" />
      ...
      <p className='text-center lg:text-sm text-gray-700 font-normal px-4 xl:px-18 mb-4 line-clamp-3'>{post.excerpt}</p>
