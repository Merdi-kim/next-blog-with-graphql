...
function PostDetails({post}:IPostDetailProps) {
  ...
  return (
    <div className='bg-white break-words shadow-lg rounded-lg lg:p-8 pb-12 mb-8'>
      ...
      <div className='px-4 lg:px-0'>
        ...
        <div className='flex items-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
          <img src={post.author.photo.url} height="30px" width="30px" alt={post.author.name} className="align-middle rounded-[50%] border-blue-700 border-2" />
