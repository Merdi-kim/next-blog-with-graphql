...
function PostWidget() {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 mb-8'>
      <h3 className='text-xl mb-8 font-semibold border-b border-secondary-color pb-4'>Recent Posts</h3>
      {
        recentPosts.map((post:IPost) => (
          <div key={post.title} className='flex items-center w-full mb-4'>
            ...
            <div className='flex-grow ml-4'>
              <Link href={`/post/${post.slug}`} className='text-md font-normal'> {post.title}</Link>
